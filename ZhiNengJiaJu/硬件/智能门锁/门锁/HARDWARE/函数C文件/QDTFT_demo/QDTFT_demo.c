...
void Redraw_Mainmenu(void)
{
	...
	Gui_DrawFont_GBK16(16,0,BLUE,GRAY0,"深圳艾斯科技");
	Gui_DrawFont_GBK16(16,20,RED,GRAY0,"液晶开发学习");
...
void Font_Test(void)
{
	...
	Lcd_Clear(GRAY0);
	Gui_DrawFont_GBK16(16,30,YELLOW,GRAY0,"学而不思则罔");
	Gui_DrawFont_GBK16(16,50,BLUE,GRAY0,"思而不学则殆");
	Gui_DrawFont_GBK16(16,70,RED,GRAY0, "欢迎一起交流");
	Gui_DrawFont_GBK16(16,90,BLUE,GRAY0,"Q Q:978530718");
	Gui_DrawFont_GBK16(5,110,RED,GRAY0, "www.qdtech.net");
...
void showimage(const unsigned char *p) //显示40*40 QQ图片
{
  int i;	
	...
	Lcd_Clear(WHITE);               //清屏  
	 ...
	 Lcd_SetRegion(4,4,123,123);		//坐标设置
	 for(i=0;i<120*120;i++)
	 {	
		picL=*(p+i*2);	              //数据低位在前
		picH=*(p+i*2+1);				
